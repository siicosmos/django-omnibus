...
SERVER_SSL = getattr(settings, 'OMNIBUS_SERVER_SSL', False)
SERVER_SSL_KEY = getattr(settings, 'OMNIBUS_SERVER_SSL_KEY', '')
SERVER_SSL_CERT = getattr(settings, 'OMNIBUS_SERVER_SSL_CERT', '')
